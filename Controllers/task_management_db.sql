...
(8, 'member Training Program Development', 'Develop and implement a new training program focused on enhancing member skills in project management and teamwork.', 2, '2024-09-01', 'pending', '2024-08-31 10:52:11'),
...
(21, 'Onboard new members', 'Complete HR onboarding tasks for the new hires', 7, '2024-09-07', 'pending', '2024-09-06 08:03:44'),
...
CREATE TABLE `users` (
  ...
  `role` enum('admin', 'member', 'teamleader') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'Elias A.', 'elias', '$2y$10$8xpI.hVCVd/GKUzcYTxLUO7ICSqlxX5GstSv7WoOYfXuYOO/SZAZ2', 'member', '2024-08-28 07:10:40'),
(7, 'John', 'john', '$2y$10$CiV/f.jO5vIsSi0Fp1Xe7ubWG9v8uKfC.VfzQr/sjb5/gypWNdlBW', 'member', '2024-08-29 17:11:21'),
(8, 'Oliver', 'oliver', '$2y$10$E9Xx8UCsFcw44lfXxiq/5OJtloW381YJnu5lkn6q6uzIPdL5yH3PO', 'member', '2024-08-29 17:11:34');
